...
public class HttpRequest {
    ...
    public static String sendGet(String url, String param, String useragent) {
        ...
        try {
        	...
        	if(param==null || "".equals(param)) urlNameString = url;
...
//            System.out.println("以下为响应头内容:" + map);
            
            // 定义 BufferedReader输入流来读取URL的响应
            //zhj:必须要进行编码处理 ，否则变成乱码报错;
...
//            e.printStackTrace();
    ...
    public static String sendGet(String url, String param) {
    	...
    	return HttpRequest.sendGet(url, param, useragent);
    }
 
    public static String sendGet(String url) {
    	String useragent =  "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1;SV1)";
    	return HttpRequest.sendGet(url, "", useragent);
    }
    ...
    public static String sendPost(String url) {
    	return HttpRequest.sendPost(url, "");
    }
